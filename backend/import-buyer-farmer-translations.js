...
async function main() {
  try {
    console.log('🚀 Starting Buyer & Farmer translations import...\n');
    ...
    // Import buyer and farmer namespaces
    for (const namespace of ['buyer', 'farmer']) {
    ...
    console.log(`\n🎉 Buyer & Farmer translations import completed!`);
    console.log(`\n📊 Overall Summary:`);
    ...
    console.log(`2. Select "buyer" or "farmer" from the namespace dropdown`);
    console.log(`3. Test the translations in the buyer and farmer dashboards`);
    console.log(`4. The translations are now available for use in React components`);
